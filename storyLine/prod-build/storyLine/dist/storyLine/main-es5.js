...
var AppComponent = /** @class */ (function () {
    function AppComponent(sql, snackBarService, snackBar, authService, router) {
        this.sql = sql;
    ...
    AppComponent.prototype.listenForSnackBarOpen = function () {
        var _this = this;
        this.subs.add(this.snackBarService.onOpenSnackBar.subscribe(function (data) {
            return _this.openSnackbar({ message: data.message, isError: data.isError });
        }));
    };
    AppComponent.prototype.listenForSnackBarClose = function () {
        var _this = this;
        this.subs.add(this.snackBarService.onCloseSnackBar.subscribe(function () { return _this.snackBar.dismiss(); }));
    };
    AppComponent.prototype.openSnackbar = function (data) {
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.setUser = function (username, email) {
...
var BookmarksComponent = /** @class */ (function () {
    function BookmarksComponent(sql) {
        this.sql = sql;
    }
    ...
    BookmarksComponent.prototype.loadBookmarkedStories = function () {
        var _this = this;
        this.sql.getBookmarkedStories(sessionStorage.getItem('username'))
            .subscribe(function (bookmarkedStories) {
            _this.selectedStories = bookmarkedStories;
            console.log(_this.selectedStories);
        });
    };
...
var FriendFeedComponent = /** @class */ (function () {
    function FriendFeedComponent(sql) {
        this.sql = sql;
        this.subs = new rxjs__WEBPACK_IMPORTED_MODULE_3__["Subscription"]();
    }
    FriendFeedComponent.prototype.ngOnInit = function () {
        this.selectedStories = [];
        this.loadFriendStories();
    };
    FriendFeedComponent.prototype.loadFriendStories = function () {
        var _this = this;
        this.subs.add(this.sql.getFriendStories().subscribe(function (selectedStories) {
            _this.selectedStories = selectedStories;
        }));
    };
    FriendFeedComponent.ctorParameters = function () { return [
        { type: _sql_service__WEBPACK_IMPORTED_MODULE_2__["SQLService"] }
    ]; };
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(sql, _bottomSheet, dialog) {
        this.sql = sql;
    ...
    HomeComponent.prototype.getOneLiners = function () {
        var _this = this;
        this.subs.add(this.sql.getOneLiners().subscribe(function (oneLiners) {
            _this.oneLiners = oneLiners;
        }));
    };
    HomeComponent.prototype.listenForOneLiners = function () {
        var _this = this;
        this.subs.add(this.sql.onAddOneliner.subscribe(function (newOneLinerObj) {
            _this.addOneLiner(newOneLinerObj);
        }));
    };
    HomeComponent.prototype.listenForStories = function () {
        var _this = this;
        this.subs.add(this.sql.onInsertStory.subscribe(function (storyObj) {
            _this.sql.dialogueRef.close();
            _this.fetchStories(storyObj);
        }));
    };
    HomeComponent.prototype.updateLike = function (liked, oneLiner) {
        console.log(liked);
        oneLiner = { "oneLiner": oneLiner, "change": liked };
        this.sql.updateOneLinerNumUpVotes(oneLiner).subscribe(function (res) {
        }, function (error) { return console.log(error); });
    };
    HomeComponent.prototype.onSubmitOneliner = function () {
        this._bottomSheet.open(_submit_one_liner_submit_one_liner_component__WEBPACK_IMPORTED_MODULE_4__["SubmitOneLinerComponent"]);
    };
    HomeComponent.prototype.addOneLiner = function (newOneLiner) {
        var _this = this;
        newOneLiner = {
        ...
        this.sql.insertOneLiner(newOneLiner).subscribe(function (res) {
            _this.getOneLiners();
        }, function (error) { return console.log(error); });
    };
    HomeComponent.prototype.fetchStories = function (oneLinerObj) {
        var _this = this;
        sessionStorage.setItem('oneLiner', oneLinerObj.oneLiner);
        this.subs.add(this.sql.selectStoryByOneLiner(oneLinerObj).subscribe(function (res) {
            _this.selectedStories = res;
            var stories = res;
            _this.openStoriesView(stories, oneLinerObj.oneLiner);
            if (res[0]['exist'] == 1) {
                _this.storiesExist = 1;
            }
            _this.selectedOneliner = oneLinerObj.oneLiner;
            _this.sql.selectedOneliner = oneLinerObj.oneLiner;
        }));
    };
    HomeComponent.prototype.openStoriesView = function (stories, oneLiner) {
...
var OnelinerCardComponent = /** @class */ (function () {
    function OnelinerCardComponent(sql) {
        this.sql = sql;
    ...
    OnelinerCardComponent.prototype.ngOnInit = function () {
        this.getLiked();
    };
    OnelinerCardComponent.prototype.getLiked = function () {
        var _this = this;
        this.subs.add(this.sql.getLikedOneLiner(this.oneLiner.oneLiner).subscribe(function (result) {
            if (result['liked']) {
                _this.liked = 1;
            }
            else {
    ...
    OnelinerCardComponent.prototype.onLike = function () {
        this.likeObj = { 'oneLiner': this.oneLiner.oneLiner, 'authorUsername': sessionStorage.getItem('username') };
        if (this.liked == 0) {
            this.oneLiner.numUpVotes++;
            this.liked = 1;
            this.subs.add(this.sql.addLikeOneLiner(this.likeObj).subscribe(function (result) { }));
        }
        else {
            this.oneLiner.numUpVotes--;
            this.liked = 0;
            this.subs.add(this.sql.removeLikeOneLiner(this.likeObj).subscribe(function (result) { }));
        }
        this.onUpdateLike.next(this.liked);
    };
    OnelinerCardComponent.ctorParameters = function () { return [
        { type: _sql_service__WEBPACK_IMPORTED_MODULE_2__["SQLService"] }
    ]; };
...
var StoriesSsComponent = /** @class */ (function () {
    function StoriesSsComponent(dialogRef, data, _bottomSheet, sql) {
        this.dialogRef = dialogRef;
        this.data = data;
        this._bottomSheet = _bottomSheet;
        this.sql = sql;
    }
    StoriesSsComponent.prototype.ngOnInit = function () {
...
var StoriesComponent = /** @class */ (function () {
    ...
    StoriesComponent.prototype.getBookmarked = function () {
        var _this = this;
        //console.log(this.sql.getBookmarked(this.story.storyHashID));
        this.subs.add(this.sql.getBookmarked(this.story.storyHashID).subscribe(function (result) {
    ...
    StoriesComponent.prototype.onBookmark = function () {
        ...
        if (this.bookmarked) {
            ...
            this.subs.add(this.sql.removeBookmark(this.bookmarkObj).subscribe(function (result) { }));
        }
        else {
            //console.log('just bookmarked');
            this.bookmarked = 1;
            this.subs.add(this.sql.addBookmark(this.bookmarkObj).subscribe(function (result) { }));
        }
    };
    StoriesComponent.prototype.getLiked = function () {
        var _this = this;
        console.log('in get liked');
        console.log(this.sql.getLiked(this.story.storyHashID));
        this.subs.add(this.sql.getLiked(this.story.storyHashID).subscribe(function (result) {
            if (result['liked']) {
    ...
    StoriesComponent.prototype.onLike = function () {
        this.likeObj = { 'storyHashID': this.story.storyHashID, 'authorUsername': sessionStorage.getItem('username') };
        console.log(this.liked);
        if (this.liked) {
            this.liked = 0;
            this.justLiked = 0;
            this.subs.add(this.sql.removeLike(this.likeObj).subscribe(function (result) { }));
            this.story['change'] = 0;
            this.subs.add(this.sql.updateStoriesNumUpVotes(this.story).subscribe(function (result) { }));
        }
        else {
            this.liked = 1;
            this.justLiked = 1; // Keeps track of if the user just added a like
            this.subs.add(this.sql.addLike(this.likeObj).subscribe(function (result) { }));
            this.story['change'] = 1;
            this.subs.add(this.sql.updateStoriesNumUpVotes(this.story).subscribe(function (result) { }));
        }
    };
    StoriesComponent.prototype.getFollowing = function () {
        var _this = this;
        if (this.story.authorUsername == sessionStorage.getItem('username')) {
            this.me = 1;
        }
        this.subs.add(this.sql.getFollowing(this.story.authorUsername).subscribe(function (result) {
    ...
    StoriesComponent.prototype.onFollow = function () {
        this.followObj = { 'followed': this.story.authorUsername, 'follower': sessionStorage.getItem('username') };
        if (this.following) {
            this.following = 0;
            this.subs.add(this.sql.removeFollower(this.followObj).subscribe(function (result) { }));
        }
        else {
            this.following = 1;
            this.subs.add(this.sql.addFollower(this.followObj).subscribe(function (result) { }));
        }
    };
...
var SubmitOneLinerComponent = /** @class */ (function () {
    function SubmitOneLinerComponent(_bottomSheetRef, sql, datePipe) {
        this._bottomSheetRef = _bottomSheetRef;
        this.sql = sql;
        this.datePipe = datePipe;
    }
    SubmitOneLinerComponent.prototype.ngOnInit = function () {
        this.initForm();
    };
    SubmitOneLinerComponent.prototype.initForm = function () {
    ...
    SubmitOneLinerComponent.prototype.onSubmitForm = function () {
        var oneLinerObj = {
    ...
    SubmitOneLinerComponent.ctorParameters = function () { return [
    ...
    return SubmitOneLinerComponent;
}());
...
var SubmitStoryComponent = /** @class */ (function () {
    function SubmitStoryComponent(_bottomSheetRef, sql, snackBarService, datePipe) {
        this._bottomSheetRef = _bottomSheetRef;
        this.sql = sql;
        this.snackBarService = snackBarService;
        this.datePipe = datePipe;
    ...
    SubmitStoryComponent.prototype.ngOnInit = function () {
        this.initForm();
        this.username = sessionStorage.getItem('username');
    };
    SubmitStoryComponent.prototype.ngAfterViewInit = function () {
        // this.submitType.selected.value = this.username;
    };
    SubmitStoryComponent.prototype.initForm = function () {
        this.storySubmitForm = new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormGroup"]({
            'content': new _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormControl"](null)
        });
    };
    ...
    //   }
    // }
    SubmitStoryComponent.prototype.onSubmitForm = function () {
        var _this = this;
        var writtenAnon = this.submitType.selected.value == 'anonymous' ? true : false;
        ...
        this.sql.insertStory(storyObj).subscribe(function (res) {
            _this.snackBarService.onOpenSnackBar.next({ message: "Your story was successfully published", isError: false });
            // setTimeout(function(){ }, 4000);
            _this._bottomSheetRef.dismiss();
            _this.sql.onInsertStory.next(storyObj);
        }, function (error) {
            if (error.statusText === 'Created')
                _this.snackBarService.onOpenSnackBar.next({ message: "Plagiarism!", isError: true });
        });
    };
    SubmitStoryComponent.ctorParameters = function () { return [
        { type: _angular_material_bottom_sheet__WEBPACK_IMPORTED_MODULE_2__["MatBottomSheetRef"] },
...
var ToolbarComponent = /** @class */ (function () {
    ...
    ToolbarComponent.prototype.onOpen = function () {
        console.log("in onOpen");
        this.onOpenSideNav.next();
    };
    ToolbarComponent.prototype.onDismiss = function () {
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(router, authService, snackBarService) {
        this.router = router;
        this.authService = authService;
        this.snackBarService = snackBarService;
    }
    ...
    LoginComponent.prototype.onSubmit = function () {
        ...
        this.authService.login(this.loginForm.value.username, this.loginForm.value.password)
            ...
            if (res && !res[0]['valid']) {
                _this.handleError("Invalid username or password");
                return;
            }
            if (res && res[0]['valid']) {
                _this.authService.setUser(res[0]['username'], res[0]['email']);
...
var MyStoriesComponent = /** @class */ (function () {
    function MyStoriesComponent(sql) {
        this.sql = sql;
    ...
    MyStoriesComponent.prototype.loadMyStories = function () {
        var _this = this;
        this.subs.add(this.sql.getMyStories().subscribe(function (selectedStories) {
            _this.selectedStories = selectedStories;
        }));
    };
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(snackBarService, authService, router) {
        this.snackBarService = snackBarService;
        this.authService = authService;
        this.router = router;
        this.user = {
    ...
    ProfileComponent.prototype.onSubmit = function () {
        ...
        if (this.forgotForm.value.new !== this.forgotForm.value.confirm)
            ...
            this.authService.updatePassword(this.user['username'], this.forgotForm.value.new)
                .subscribe(function (res) {
                _this.provideFeedback("Password Succesfully Updated", false);
            }, function (error) { return console.log(error); });
        }
    };
    ProfileComponent.prototype.provideFeedback = function (message, isError) {
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(router, authService, snackBarService) {
        this.router = router;
        this.authService = authService;
        this.snackBarService = snackBarService;
    }
    ...
    RegisterComponent.prototype.onSubmit = function () {
        ...
        this.authService.register(this.registerForm.value.username, this.registerForm.value.email, this.registerForm.value.password)
            ...
            if (error.statusText === 'Created')
                _this.handleError("An account with this username already exists.");
            else
                console.log(error);
        });
    };
...
var FormsMaterialComponentsModule = /** @class */ (function () {
    function FormsMaterialComponentsModule() {
    }
    ...
    return FormsMaterialComponentsModule;
}());
...
var SnackBarComponent = /** @class */ (function () {
    function SnackBarComponent(data, snackBarService) {
        this.data = data;
        this.snackBarService = snackBarService;
    }
    SnackBarComponent.prototype.ngOnInit = function () {
    };
    SnackBarComponent.prototype.onSnackBarClose = function () {
...
var SQLService = /** @class */ (function () {
    ...
    SQLService.prototype.removeBookmark = function (bookmarkObj) {
    ...
    SQLService.prototype.removeLikeOneLiner = function (likeObj) {
    ...
    SQLService.prototype.addLikeOneLiner = function (likeObj) {
        console.log(likeObj);
        return this.http.post(this.baseUrl + "/insertAcctsLikeOneLiners.php", likeObj);
    };
    SQLService.prototype.getLiked = function (storyHashID) {
    ...
    SQLService.prototype.removeLike = function (likeObj) {
